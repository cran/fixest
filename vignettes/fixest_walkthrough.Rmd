...
The function `coefplot` detects that the results contain interactions and plot the appropriate graph. In case you wanted to display al the coefficients, including \code{x1}, you can use the argument \code{only.inter = FALSE}. 
