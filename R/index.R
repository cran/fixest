...
#' \item{Easy and flexible clustering of standard-errors. By using the arguments \code{se} and \code{dof} (see \code{\link[fixest]{summary.fixest}}). To have a sense of how the standard errors are computed, see the vignette \href{https://lrberge.github.io/fixest/articles/standard_errors.html}{On standard-errors}.}
