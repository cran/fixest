...
#' \item{Easy and flexible clustering of standard-errors. By using the arguments \code{vcov} and \code{ssc} (see \code{\link[fixest]{summary.fixest}}). To have a sense of how the standard errors are computed, see the vignette \href{https://lrberge.github.io/fixest/articles/standard_errors.html}{On standard-errors}.}
#' \item{Visualization and exportation of results. You can visualize the results of multiple estimations in R, or export them in Latex using the function \code{\link[fixest]{etable}}. This vignette details how to customize the Latex tables: \href{https://lrberge.github.io/fixest/articles/exporting_tables.html}{Exporting estimation tables}.}
