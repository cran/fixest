...
![Illustration adj](https://github.com/lrberge/fixest/blob/master/vignettes/images/SE/adj.png?raw=true)
...
![Small data set](https://github.com/lrberge/fixest/blob/master/vignettes/images/SE/sample_data.png?raw=true)
...
![Illustration fixef.K](https://github.com/lrberge/fixest/blob/master/vignettes/images/SE/K_computation.png?raw=true)
...
![Illustration cluster.adj](https://github.com/lrberge/fixest/blob/master/vignettes/images/SE/cluster_adj_one_way.png?raw=true)
...
![Illustration cluster.adj 2-way](https://github.com/lrberge/fixest/blob/master/vignettes/images/SE/cluster_adj_two_way.png?raw=true)
...
![Small collinearity data](https://github.com/lrberge/fixest/blob/master/vignettes/images/SE/exact_collinearity.png?raw=true)
...
![Illustration cluster.df](https://github.com/lrberge/fixest/blob/master/vignettes/images/SE/cluster_df_min.png?raw=true)
...
Zeileis A (2004). “[Econometric Computing with HC and HAC Covariance Matrix Estimator](https://www.jstatsoft.org/article/view/v011i10)”, Journal of Statistical Software, 11(10), 1–17.
